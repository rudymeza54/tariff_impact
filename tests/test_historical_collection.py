# test_historical_collection.py - Fixed version
import os
import sys
import logging
import sqlalchemy
...
try:
    ...
    from src.collectors.market_data_collector import collect_historical_data, get_db_connection
    
    # Use a larger set of tickers for historical collection
    import src.collectors.market_data_collector as mdc
    ...
    # Collect data from March 1, 2024 (not 2025)
    # Using only start_date since your function doesn't accept end_date
    records_added = collect_historical_data(start_date="2024-03-01")
